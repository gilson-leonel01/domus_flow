...
('11111111-1111-1111-1111-111111111111','bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb','aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Preparar o pequeno-almoço','Organizar a mesa e preparar o pequeno-almoço da família',(now() AT TIME ZONE 'Africa/Luanda')::date,'07:30',40,3),
('11111111-1111-1111-1111-111111111111','bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb','aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Limpar a sala','Varrer, limpar superfícies e organizar almofadas',(now() AT TIME ZONE 'Africa/Luanda')::date,'09:00',60,2),
('11111111-1111-1111-1111-111111111111','cccccccc-cccc-cccc-cccc-cccccccccccc','aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Arrumar o quarto','Guardar roupas e organizar a secretária',(now() AT TIME ZONE 'Africa/Luanda')::date,'17:00',25,2) ON CONFLICT DO NOTHING;
